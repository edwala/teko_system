        ...
        <table class="table">
            ...
            <tr>
                <td class="px-0">
                    @if($invoice->getDate())
                        <p class="buyer-name">
                            {{ __('invoices::invoice.method_of_payment') }}: {{  __('invoices::invoice.methods.' . $invoice->seller->methods['method_of_payment']) }}
                        </p>
                    @endif

                    @if($invoice->getDate())
                        <p class="buyer-address">
                            {{ __('invoices::invoice.vs') }}: {{ $invoice->getSerialNumber() }}
                        </p>
                    @endif

                    @if($invoice->getDate())
                        <p class="buyer-code">
                            {{ __('invoices::invoice.account') }}: {{ $invoice->seller->methods['account'] }}/{{ $invoice->seller->methods['bank_code'] }}
                        </p>
                    @endif
                </td>
                <td class="border-0"></td>
                <td class="px-0">
                    ...
                    @if($invoice->getDate())
                        <p class="buyer-address">
                            {{ __('invoices::invoice.taxable') }}: {{ $invoice->getDate() }}
                        </p>
                    @endif
