    ...
    <form wire:submit.prevent="updateCompanyName" class="col-span-2 mt-5 sm:col-span-1 md:mt-0">
        <x-filament::card>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-forms::field-wrapper id="bank_code" statePath="bank_code" required="true" label="{{ __('filament-companies::default.labels.bank_code') }}">

                    <x-filament-companies::input id="bank_code" type="text"
                                                 wire:model.defer="state.bank_code" :disabled="!Gate::check('update', $company)" />
