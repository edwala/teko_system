<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.bank_statements.index_title')
        </h2>
    </x-slot>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    <div
                                        ...
                                        "
                                    >
                                        @can('update', $bankStatement)
                                        <a
                                            href="{{ route('bank-statements.edit', $bankStatement) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $bankStatement)
                                        <a
                                            href="{{ route('bank-statements.show', $bankStatement) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $bankStatement)
                                        <form
                                            action="{{ route('bank-statements.destroy', $bankStatement) }}"
                                            method="POST"
